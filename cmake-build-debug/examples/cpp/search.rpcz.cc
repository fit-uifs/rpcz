...
void SearchService::Search(const ::examples::SearchRequest&,
                         ::rpcz::reply< ::examples::SearchResponse> reply) {
...
void SearchService::call_method(const ::google::protobuf::MethodDescriptor* method,
  ...
  switch(method->index()) {
    case 0:
      Search(
          *::google::protobuf::down_cast<const ::examples::SearchRequest*>(&request),
          ::rpcz::reply< ::examples::SearchResponse>(channel));
      break;
    default:
...
const ::google::protobuf::Message& SearchService::GetRequestPrototype(
  ...
  switch(method->index()) {
    case 0:
      return ::examples::SearchRequest::default_instance();
    default:
      GOOGLE_LOG(FATAL) << "Bad method index; this should never happen.";
...
const ::google::protobuf::Message& SearchService::GetResponsePrototype(
  ...
  switch(method->index()) {
    case 0:
      return ::examples::SearchResponse::default_instance();
    default:
      GOOGLE_LOG(FATAL) << "Bad method index; this should never happen.";
      return *reinterpret_cast< ::google::protobuf::Message*>(NULL);
  }
...
void SearchService_Stub::Search(const ::examples::SearchRequest& request,
